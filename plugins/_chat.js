let handler = m => m; 
 ...
                   'اوكي ✨💜'
         ]; 
   }else if (/^|نيزكو| نيزوكو | نيزوكو|  نيزو | نيزوكو تشان $/i.test(m.text)) { 
     responses = [ 
       ' *يوريتشي بيحبها🫶❤️*',  
          ' *صديقة يوريتشي المقربه🫶❤️* ',  
              ' *صديقة يوريتشي 🫶❤️* ',  
                  '  *صديقة يوريتشي طول العمر 🫶❤️*',  
                   ' *صديقة يوريتشي الروح بالروح 🫶❤️*'
     ]; 
 ...
                             'دوم '
         ]; 
   }else if (/^جين|عبد العزيز|فيستا|ايتاتشي|ايتاشي|اوراهارا$/i.test(m.text)) { 
     responses = [ 
